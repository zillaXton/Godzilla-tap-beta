...
const App = () => {
  ...
  const handleJoinSquadClick = () => {
    window.location.href = "https://t.me/godzillaonton";
  };
    ...
    <div className="bg-gradient-main min-h-screen px-4 flex flex-col items-center text-white font-medium">
      ...
      <div className="w-full z-10 min-h-screen flex flex-col items-center text-white">
        ...
        <div className="fixed top-0 left-0 w-full px-4 pt-8 z-10 flex flex-col items-center text-white">
          <div className="w-full cursor-pointer" onClick={handleJoinSquadClick}>
        ...
        <div className="fixed bottom-0 left-0 w-full px-4 pb-4 z-10">
          <div className="w-full flex justify-between gap-2">
            ...
            <div className="flex-grow flex items-center max-w-60 text-sm">
              <div className="w-full bg-[#07befb] py-4 rounded-2xl flex justify-around">
                <button className="flex flex-col items-center gap-1">
                  <img src={bear} width={24} height={24} alt="High Voltage" />
                  <span>Frens</span>
                </button>
                <div className="h-[48px] w-[2px] bg-[#07befb]"></div>
                <button className="flex flex-col items-center gap-1">
          ...
          <div className="w-full bg-[#08465e] rounded-full mt-4">
            <div className="bg-gradient-to-r from-[#08465e] to-[#fffad0] h-4 rounded-full" style={{ width: `${(energy / 6500) * 100}%` }}></div>
          </div>
        </div>
